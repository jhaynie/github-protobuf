...
func TestStatusEvent(t *testing.T) {
	...
	err := json.Unmarshal([]byte(event), &statusEvent)
	if err != nil {
		t.Error(err)
	} else {
		if statusEvent.Sha != "9049f1265b7d61be4a8904a9a27120d2064dab3b" {
			t.Error("statusEvent.Sha != 9049f1265b7d61be4a8904a9a27120d2064dab3b")
		}
		if statusEvent.Commit.Sha != "9049f1265b7d61be4a8904a9a27120d2064dab3b" {
			t.Error("statusEvent.Commit.Sha != 9049f1265b7d61be4a8904a9a27120d2064dab3b")
		}
		repo := statusEvent.Repository
		if repo.Id != 35129377 {
			t.Error("statusEvent.Repository.Id != 35129377")
		}
		sender := statusEvent.Sender
		if sender.Login != "baxterthehacker" {
			t.Error("statusEvent.Sender.Login != baxterthehacker")
		}
	}
}
